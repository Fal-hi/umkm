...
<div class="row">
	<div class="col-md-12">
		<div class="box">
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						...
						<div class="box-title">
							<h3><i class="fa fa-table"></i> Anggota</h3>
							<div class="box-tool">
								<a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
							</div>
						</div>
						<div class="box-content">
							<!-- <a href="index.php?p=tambahanggota"><button class="btn btn-success">Tambah Data</button></a> -->
						</div>
						<div class="box-content">
          ...
          $q = mysqli_query(
            $con,
            "SELECT * FROM anggota ORDER BY tgldaftar desc"
          );
          while ($r = mysqli_fetch_array($q)) { ?>
										<tr>
											...
											<td width="20%">
												<a href="index.php?p=editanggota&id=<?php echo $r[
              "idanggota"
            ]; ?>"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> Edit</button></a>
												<a href="index.php?p=conhapusanggota&id=<?php echo $r["idanggota"]; ?>" 
