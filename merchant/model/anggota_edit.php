   ...
   ?>
           ...
           "namalengkap"
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-lg-10 controls">
									<input type="text" name="nohp" placeholder="" class="form-control" required autofocus value="<?php echo $r[
           "nohp"
         ]; ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9 col-lg-10 controls">
									<textarea name="alamat" rows="5" class="form-control" required autofocus><?php echo $r[
           "alamat"
         ]; ?></textarea>
								</div>
							</div>
