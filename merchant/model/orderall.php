					...
					<tr>
						...
						<td>
							<?php if ($r["idstatusorder"] == "1") { ?>
								<a href="index.php?p=conorderkonfirmasicancel&amp;id=<?php echo $r["idorder"]; ?>" class="bagde bg-secondary">
									<i class="bi bi-x-lg"></i> Batal
								</a>

							<?php } elseif ($r["idstatusorder"] == "3") { ?>

								<a href="index.php?p=conorderkonfirmasiberhasil&amp;id=<?php echo $r["idorder"]; ?>" class="bagde bg-secondary">
