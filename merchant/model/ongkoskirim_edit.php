...
<div class="row">
	<div class="col-md-12">
		<div class="box box-green">
			...
			<?php
   $id = $_GET["id"];
   $q = mysqli_query($con, "SELECT * FROM kota WHERE idkota = '$id'");
				...
				<form method="POST" action="index.php?p=coneditongkoskirim" class="form-horizontal form-row-separated" enctype="multipart/form-data">
					<div class="form-group">
						...
						<div class="col-sm-9 col-lg-10 controls">
							<input type="text" name="namakota" placeholder="" class="form-control" required autofocus value="<?php echo $r[
         "namakota"
       ]; ?>">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-lg-10 controls">
							<input type="text" name="tarif" placeholder="" class="form-control" required autofocus value="<?php echo $r[
         "tarif"
       ]; ?>">
						</div>
					</div>
