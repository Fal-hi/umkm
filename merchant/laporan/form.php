								...
								<td colspan="3">
									<div class="form-group">
										...
										<div class="col-sm-12 col-lg-12 controls">
											<input class="form-control date-picker" name="tglawal" size="16" type="date" />
										</div>
									</div>
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<div class="form-group">
										...
										<div class="col-sm-12 col-lg-12 controls">
											<input class="form-control date-picker" name="tglakhir" size="16" type="date" />
										</div>
									</div>
								</td>
							</tr>
						</table>
						<input type="hidden" name="idmerchant" value="<?php echo $idadmin; ?>">
						<br><br>
						<button type="submit" class="btn btn-success" formaction="laporan/laporan_harian.php">Cetak Laporan</button></a><br><br>
