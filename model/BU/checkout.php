    ...
    <div class="row">
                            ...
                            <select class="form-control" name="idkota" required autofocus>
                                ...
                                ?>
                                    <option value="<?php echo $hkota["idkota"]; ?>">
                                        <?php echo $hkota["namakota"]; ?> || Rp.<?php echo number_format($hkota["tarif"]); ?>
                                    </option>
                                <?php 
                                }
                                ?>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <?php
                $total = 0;
                $q = mysqli_query($con, "SELECT cart.*, produk.namaproduk, produk.hargaproduk, produk.foto FROM cart LEFT JOIN produk ON cart.idproduk = produk.idproduk WHERE cart.idanggota = '$idanggota'");
                $path = "images/produk/";
                    ...
                    <div class="row property-listing">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="pull-right">
                                <!-- <a href="index.php?p=conhapuscart&id=<?php echo $r["idcart"]; ?>"><i class="fa fa-trash"></i> Cancel
                                </a> -->
                            </div>
                        </div>  
                    </div>
            ...
            <div class="row">
                ...
                <p>Note : Harga Masih Diluar Ongkos Kirim</p>
            </div>
            <br><br>
