...
<body onload="window.print()">
  ...
  <font>
    <p align="center">
      ...
      <font size="6px">Go-Online</font><br>Laporan Pemesanan Bulanan
    </p>
  </font>
  <hr noshade="1">
  <br>
  <h3 align="center"> Laporan Pemesanan Bulanan</h3><br>
  <h5>
  ...
  <div align="right">
    <table class="second">
      <tr class="second">
        <td align="center" class="second">PANYABUNGAN, <?php echo $dateformat; ?>
        <br><br><br><br><br>
          <?php echo $pimpinan; ?>
        </td>
      </tr>
