...
<body onload="window.print()">
  ...
  <font>
    <p align="center">
      ...
      <font size="6px">Go-Online</font><br>Laporan Pemesanan Tahunan
    </p>
  </font>
  <hr noshade="1">
  <br>
  <h3 align="center"> Laporan Pemesanan Tahunan</h3><br>
  <h5>
  ...
  <table align="center" width="100%">
    ...
    ?>
      <tr align="center">
        ...
        <td width="20%" rowspan="<?php echo $rows + 1; ?>">
          <?php echo $r["idorder"]; ?>
        </td>
      </tr>
    <?php
    ...
    <?php
      ...
      WHERE idorder = '$r[idorder]' AND (orderdetail.idstatusorder = 3 OR orderdetail.idstatusorder = 4)");
      while ($h = mysqli_fetch_array($qqq)) { 
    ?>
        <tr align="center">
          <td width="25%"><?php echo $h["namaproduk"]; ?></td>
          <td width="15%">
            Rp.<?php echo number_format($h["hargaproduk"]); ?>
          </td>
