							...
							<div class="table-responsive" style="border:0">
								<table class="table table-advance" id="table1">
									...
									<tbody>
										<?php
											$no = 1;
											$q = mysqli_query($con, "SELECT * FROM admin ORDER BY idadmin ASC");
										...
										<tr>
											...
											<td width="20%">
												<a href="index.php?p=editadmin&id=<?php echo $r["idadmin"]; ?>">
												<button type="button" class="btn btn-primary">
													<span class="glyphicon glyphicon-pencil">
													</span> 
													Edit</button>
												</a>
												<a href="index.php?p=conhapusadmin&id=<?php echo $r["idadmin"]; ?>" onClick="return confirm('Yakin anda akan menghapus?')">
