...
<div id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li>
			<a href="index.php?p=penjual">Daftar Penjual</a>
			<span class="divider"><i class="fa fa-angle-right"></i></span>
		</li>
...
<div class="row hidden-xs">
	<div class="col-md-12">
		<div class="box box-green">
			<div class="box-title">
				<h3><i class="fa fa-bars"></i> Edit Data Penjual</h3>
				<div class="box-tool">
			...
			<?php
				$id = $_GET["id"];
				$q = mysqli_query($con, "SELECT * FROM merchant WHERE idmerchant = '$id'");
				$r = mysqli_fetch_array($q);
			?>
			<div class="box-content">
				<form method="POST" action="index.php?p=coneditpenjual" class="form-horizontal">
					<div class="row">
						<div class="col-md-6 ">
							<!-- BEGIN Left Side -->
							<div class="form-group">
								...
								<div class="col-sm-9 col-lg-10 controls">
									<input type="text" name="namalengkap" placeholder="" class="form-control" required autofocus value="<?php echo $r["namatoko"]; ?>">
						...
						<div class="col-md-6 ">
							<!-- BEGIN Right Side -->
							<div class="form-group">
								<label for="textfield2" class="col-xs-3 col-lg-2 control-label">Status</label>
								<div class="col-sm-9 col-lg-10 controls">
									<select class="form-control" name="status"><
										<?php
											if ($r["status"] == 1) {
												...
												$out = "Tidak Verifikasi";
											}
											echo "<option value=$r[status]>$out</option>";
										?>
										<option value="0">Tidak Verifikasi</option>
										<option value="1">Verifikasi</option>
									</select>
									<!-- <input type="text" name="status" placeholder="" class="form-control" required autofocus value="<?php echo $r["status"]; ?>"> -->
								</div>
							</div>
							<div class="form-group">
