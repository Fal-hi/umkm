			...
			<div class="box-content">
				<form method="POST" action="index.php?p=contambahproduk" class="form-horizontal form-row-separated" enctype="multipart/form-data">
					<div class="form-group">
						<label for="textfield3" class="col-sm-3 col-lg-2 control-label">Ukuran Barang</label>
					...
					<div class="form-group">
						<label for="password3" class="col-sm-3 col-lg-2 control-label">Harga Barang</label>
						<div class="col-sm-9 col-lg-10 controls">
