							...
							<div class="table-responsive" style="border:0">
								<table class="table table-advance" id="table1">
									...
									<tbody>
										<?php
											$no = 1;
											$q = mysqli_query($con, "SELECT umkm.order.*, statusorder.namastatus FROM umkm.order LEFT JOIN statusorder ON umkm.order.idstatusorder = statusorder.idstatusorder WHERE umkm.order.idstatusorder = '2'");
										...
										?>								
											<tr>
												...
												<td>
													<a href="index.php?p=orderkonfirmasilihat&id=<?php echo $r["idorder"]; ?>&idmerchant=<?php echo $r["idmerchant"]; ?>">
