				...
				<form method="POST" action="index.php?p=coneditproduk" class="form-horizontal form-row-separated" enctype="multipart/form-data">
					<div class="form-group">
						...
						<div class="col-sm-9 col-lg-10 controls">
							<input type="text" name="idproduk" placeholder="" class="form-control" required autofocus value="<?php echo $r["idproduk"]; ?>" disabled>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-lg-10 controls">
							<input type="text" name="namaproduk" placeholder="" class="form-control" required autofocus value="<?php echo $r["namaproduk"]; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="password3" class="col-sm-3 col-lg-2 control-label">Harga Produk</label>
						<div class="col-sm-9 col-lg-10 controls">
							<input type="text" name="hargaproduk" placeholder="" class="form-control" required autofocus value="<?php echo $r["hargaproduk"]; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="password3" class="col-sm-3 col-lg-2 control-label">Stok</label>
						<div class="col-sm-9 col-lg-10 controls">
							<input type="text" name="stok" placeholder="" class="form-control" required autofocus value="<?php echo $r["stok"]; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="textarea3" class="col-sm-3 col-lg-2 control-label">Detail Produk</label>
						<div class="col-sm-9 col-lg-10 controls">
							<textarea name="detailproduk" rows="5" class="form-control" required autofocus><?php echo $r["detailproduk"]; ?>
							</textarea>
						</div>
					</div>
					<div class="form-group">
